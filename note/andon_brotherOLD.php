...
try {
    ...
    /*
    $query = "SELECT operatori.nome, cicli.codice_ciclo, SUM(andon_board.num_pz_realizzati) as totale_pezzi
                FROM andon_board
                INNER JOIN operatori ON andon_board.id_operatore = operatori.id
                INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                GROUP BY operatori.nome, cicli.codice_ciclo";
    ...
    if ($result_004 && $result_004->rowCount() > 0) {
        ...
        */
        if ($dataOdierna == $data_004['data_turno'] || $dataPrec == $data_004['data_turno']) {
            ...
            if ($data_004['orario']=='22-23'||$data_004['orario']=='23-24'||$data_004['orario']=='24-1'||$data_004['orario']=='1-2'||$data_004['orario']=='2-3'||$data_004['orario']=='3-4'||$data_004['orario']=='4-5'||$data_004['orario']=='5-6') {            
                $queryTurni_004 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_004['id_operatore']."' AND id_risorsa = '".$data_004['id_risorsa']."' AND ( (data_turno = ('".$data_004['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR (data_turno = ('".$data_004['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR data_turno = '".$data_004['data_turno']."' ) 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            } else {
                $queryTurni_004 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_004['id_operatore']."' AND id_risorsa = '".$data_004['id_risorsa']."' AND data_turno = '".$data_004['data_turno']."' 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            }

            foreach ($pdo->query($queryTurni_004) as $row) {
                $efficienza_004 += round($row["efficienza"],2,PHP_ROUND_HALF_UP);
                $qualita_004    += round($row["qualita"],2,PHP_ROUND_HALF_UP);
            }
    ...
    if ($result_011 && $result_011->rowCount() > 0) {
        ...
        */
        if ($dataOdierna == $data_011['data_turno'] || $dataPrec == $data_011['data_turno']) {
            ...
            if ($data_011['orario']=='22-23'||$data_011['orario']=='23-24'||$data_011['orario']=='24-1'||$data_011['orario']=='1-2'||$data_011['orario']=='2-3'||$data_011['orario']=='3-4'||$data_011['orario']=='4-5'||$data_011['orario']=='5-6') {            
                $queryTurni_011 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_011['id_operatore']."' AND id_risorsa = '".$data_011['id_risorsa']."' AND ( (data_turno = ('".$data_011['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR (data_turno = ('".$data_011['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR data_turno = '".$data_011['data_turno']."' ) 
                                    GROUP BY id_ciclo ORDER BY data_turno ";                    
            } else {
                $queryTurni_011 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_011['id_operatore']."' AND id_risorsa = '".$data_011['id_risorsa']."' AND data_turno = '".$data_011['data_turno']."' 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            }

            foreach ($pdo->query($queryTurni_011) as $row) {
                $efficienza_011 += round($row["efficienza"],2,PHP_ROUND_HALF_UP);
                $qualita_011    += round($row["qualita"],2,PHP_ROUND_HALF_UP);
            }
    ...
    if ($result_020 && $result_020->rowCount() > 0) {
        ...
        */ 
        if ($dataOdierna == $data_020['data_turno'] || $dataPrec == $data_020['data_turno']) {
            ...
            if ($data_020['orario']=='22-23'||$data_020['orario']=='23-24'||$data_020['orario']=='24-1'||$data_020['orario']=='1-2'||$data_020['orario']=='2-3'||$data_020['orario']=='3-4'||$data_020['orario']=='4-5'||$data_020['orario']=='5-6') {            
                $queryTurni_020 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_020['id_operatore']."' AND id_risorsa = '".$data_020['id_risorsa']."' AND ( (data_turno = ('".$data_020['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR (data_turno = ('".$data_020['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR data_turno = '".$data_020['data_turno']."' ) 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            } else {
                $queryTurni_020 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_020['id_operatore']."' AND id_risorsa = '".$data_020['id_risorsa']."' AND data_turno = '".$data_020['data_turno']."' 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            }

            foreach ($pdo->query($queryTurni_020) as $row) {
                $efficienza_020 += round($row["efficienza"],2,PHP_ROUND_HALF_UP);
                $qualita_020    += round($row["qualita"],2,PHP_ROUND_HALF_UP);
            }
    ...
    if ($result_021 && $result_021->rowCount() > 0) {
        ...
        */
        if ($dataOdierna == $data_021['data_turno'] || $dataPrec == $data_021['data_turno']) {
            ...
            if ($data_021['orario']=='22-23'||$data_021['orario']=='23-24'||$data_021['orario']=='24-1'||$data_021['orario']=='1-2'||$data_021['orario']=='2-3'||$data_021['orario']=='3-4'||$data_021['orario']=='4-5'||$data_021['orario']=='5-6') {            
                $queryTurni_021 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_021['id_operatore']."' AND id_risorsa = '".$data_021['id_risorsa']."' AND ( (data_turno = ('".$data_021['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR (data_turno = ('".$data_021['data_turno']."' - INTERVAL 1 DAY) AND orario = '22-23' ) OR data_turno = '".$data_021['data_turno']."' ) 
                                    GROUP BY id_ciclo ORDER BY data_turno ";                    
            } else {
                $queryTurni_021 = " SELECT SUM(num_pz_realizzati) AS sumPzBuoni, SUM(num_pz_scarti) AS sumPzScarti, count(*) AS numRecord, (100 / ( (3600 / tempo_ciclo * (count(*) - 1)) + (1800 / tempo_ciclo) ) * SUM(num_pz_realizzati)) AS efficienza, (100 - (SUM(num_pz_scarti) / SUM(num_pz_realizzati) * 100)) AS qualita, id_risorsa, andon_board.id_ciclo, id_operatore, pzDaRealizzare, tempo_ciclo, data_turno 
                                    FROM andon_board 
                                    INNER JOIN cicli ON andon_board.id_ciclo = cicli.id_ciclo
                                    WHERE id_operatore = '".$data_021['id_operatore']."' AND id_risorsa = '".$data_021['id_risorsa']."' AND data_turno = '".$data_021['data_turno']."' 
                                    GROUP BY id_ciclo ORDER BY data_turno ";
            }

            foreach ($pdo->query($queryTurni_021) as $row) {
                $efficienza_021 += round($row["efficienza"],2,PHP_ROUND_HALF_UP);
                $qualita_021    += round($row["qualita"],2,PHP_ROUND_HALF_UP);
            }
...
<body>
    <div class="container-fluid h-100">
        ...
        <div class="row text-center pt-2 px-2">
            <div class="col-sm-3">
                <a href="efficienzaTurno.php?risorsa=004">
            ...
            <div class="col-sm-3">
                <a href="efficienzaTurno.php?risorsa=011">
            ...
            <div class="col-sm-3">
                <a href="efficienzaTurno.php?risorsa=020">
            ...
            <div class="col-sm-3">
                <a href="efficienzaTurno.php?risorsa=021">
